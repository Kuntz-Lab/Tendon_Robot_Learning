...
e_v = np.loadtxt('./csv/haptic_ana_data/haptic_pert_scale_surface_train_1.txt')
radius_list = np.loadtxt('./csv/haptic_ana_data/haptic_pert_scale_surface_train_1_scale.txt')

round_num = 9

total_demonstrations = 20

obs_train = np.ones((total_demonstrations, 5))
...
e_v_test = np.loadtxt('./csv/haptic_ana_data/haptic_pert_scale_surface_test_1.txt')
radius_list_test = np.loadtxt('./csv/haptic_ana_data/haptic_pert_scale_surface_test_1_scale.txt')

test_demonstrations = 10

obs_train_test = np.ones((test_demonstrations, 5))
...
if True: #for iter_alpha in range(len(alpha_list)):
        ...
        mean_list.append(exp_df.mean())
        std_list.append(exp_df.std())
print(mean_list)
print(std_list)
