...
saved_model_path = "./saved_models/haptic_pure_ana_5000_scale_1620451163/1620451163" # works pretty well
...
pd.DataFrame(current_array).to_csv("./csv/ana_end_test.csv")
print(exp_mean)
print(exp_std)
