...
def main(arguments):
    ...
    saved_model_path = "./saved_models_1/haptic_sphere_20_pose_all_to_c_128_128_1615438847/1615438847"
    ...
    for k in range(20):#int(Init_XY.shape[0]/4)):
        ...
        while True:
            i = i + 1
            print(start)
            input_list = [start[0] - center[0], start[1] - center[1], start[2] - center[2]]
