...
// libtendon addition: define POST_FOXY from TENDON_RCLCPP_VERSION_MAJOR
#ifndef POST_FOXY
#  ifdef TENDON_RCLCPP_VERSION_MAJOR
#    if TENDON_RCLCPP_VERSION_MAJOR > 1
#      define POST_FOXY 1
#    endif // TENDON_RCLCPP_VERSION_MAJOR > 1
#  endif // def TENDON_RCLCPP_VERSION_MAJOR
#endif // ndef POST_FOXY
